    ...
    <section className="section mission-section">
      ...
      <div className="about-text">
        <p>
          ...
          mission, "To create new leaders through our school of future African leaders in politics and in business, we
          also aim to put new faces and ideas in leadership positions in countries around the continent."
        </p>
        <p>
          Firstly, we believe that development is an inside-out process, rather than outside-in process, therefore, a
        ...
        <p>
          Secondly, we are aware that the world including Africa is at the time of danger and opportunity, our chance to
